...
/**
 * Base class that represents a query for the 'tweet' table.
 *
 *
 *
...
abstract class BookQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'twitter', $modelName = '\\Book', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, title, isbn, publisher_id, author_id FROM tweet WHERE id = :p0';
        try {
