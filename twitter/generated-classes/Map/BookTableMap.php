...
/**
 * This class defines the structure of the 'tweet' table.
 *
 *
 *
...
class BookTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'tweet.id';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'tweet.title';

    /**
     * the column name for the isbn field
     */
    const COL_ISBN = 'tweet.isbn';

    /**
     * the column name for the publisher_id field
     */
    const COL_PUBLISHER_ID = 'tweet.publisher_id';

    /**
     * the column name for the author_id field
     */
    const COL_AUTHOR_ID = 'tweet.author_id';
    ...
    /**
     * Deletes all rows from the tweet table.
     *
     * @param ConnectionInterface $con the connection to use
